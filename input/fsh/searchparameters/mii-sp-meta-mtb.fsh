...
* base = #Observation
* type = #quantity
* expression = "Observation.value.typeOf(range).high"
...
* base = #Observation
* type = #quantity
* expression = "Observation.value.typeOf(Range).low"
