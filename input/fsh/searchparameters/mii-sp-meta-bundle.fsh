...
* insert AddTransactionEntry(mii-sp-meta-medicationstatement-based-on)
* insert AddTransactionEntry(mii-sp-meta-medicationstatement-note)
...
* insert AddCollectionEntry(mii-sp-meta-medicationstatement-based-on)
* insert AddCollectionEntry(mii-sp-meta-medicationstatement-note)
