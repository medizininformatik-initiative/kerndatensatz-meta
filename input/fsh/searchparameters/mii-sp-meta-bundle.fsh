...
// ICU
* insert AddBundleEntry(sp-mii-icu-device-property-type)
* insert AddBundleEntry(mii-sp-icu-devicemetric-source)
* insert AddBundleEntry(mii-sp-icu-observation-bodysite)
* insert AddBundleEntry(mii-sp-icu-observation-component-interpretation)
* insert AddBundleEntry(mii-sp-icu-observation-component-referencerange)
* insert AddBundleEntry(mii-sp-icu-observation-interpretation)
* insert AddBundleEntry(mii-sp-icu-observation-issued)
* insert AddBundleEntry(mii-sp-icu-observation-referencerange)
* insert AddBundleEntry(mii-sp-icu-procedure-recorder)
// Studie
* insert AddBundleEntry(DocumentReference-title)
* insert AddBundleEntry(DocumentReference-size)
* insert AddBundleEntry(EvidenceVariable-characteristic-description)
* insert AddBundleEntry(Library-quellregister)
* insert AddBundleEntry(Library-relatedArtifactUrl)
* insert AddBundleEntry(ResearchStudy-armName)
* insert AddBundleEntry(ResearchStudy-label)
* insert AddBundleEntry(ResearchStudy-akronym)
* insert AddBundleEntry(ResearchStudy-finanzierung)
* insert AddBundleEntry(ResearchStudy-studienregister)
* insert AddBundleEntry(ResearchStudy-rekrutierungsstand-datum)
* insert AddBundleEntry(ResearchStudy-rekrutierungsstand-genauigkeit)
* insert AddBundleEntry(ResearchStudy-rekrutierungsstand)
* insert AddBundleEntry(ResearchStudy-rekrutierungsziel)
* insert AddBundleEntry(ResearchStudy-rekrutierungsstart)