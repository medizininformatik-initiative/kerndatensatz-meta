...
//Biobank
* insert AddTransactionEntry(mii-sp-meta-organization-beschreibung)
* insert AddTransactionEntry(mii-sp-meta-specimen-anzahl-aliquots)
* insert AddTransactionEntry(mii-sp-meta-specimen-anzahl-passagen)
* insert AddTransactionEntry(mii-sp-meta-specimen-container-capacity)
* insert AddTransactionEntry(mii-sp-meta-specimen-container-specimen-quantity)
* insert AddTransactionEntry(mii-sp-meta-organization-collection-design)
* insert AddTransactionEntry(mii-sp-meta-specimen-einstellung-blutversorgung)
* insert AddTransactionEntry(mii-sp-meta-specimen-fasting-status)
* insert AddTransactionEntry(mii-sp-meta-specimen-gehoert-zu)
* insert AddTransactionEntry(mii-sp-meta-specimen-kulturprotokoll)
* insert AddTransactionEntry(mii-sp-meta-specimen-art-der-modifikation)
* insert AddTransactionEntry(mii-sp-meta-specimen-zielgen)
* insert AddTransactionEntry(mii-sp-meta-specimen-modifikationen)
* insert AddTransactionEntry(mii-sp-meta-specimen-note)
* insert AddTransactionEntry(mii-sp-meta-specimen-probenebene)
* insert AddTransactionEntry(mii-sp-meta-specimen-processing-temp)
* insert AddTransactionEntry(mii-sp-meta-organization-collection-setting)
* insert AddTransactionEntry(mii-sp-meta-organization-contact-rolle)
...
//Biobank
* insert AddCollectionEntry(mii-sp-meta-organization-beschreibung)
* insert AddCollectionEntry(mii-sp-meta-specimen-anzahl-aliquots)
* insert AddCollectionEntry(mii-sp-meta-specimen-anzahl-passagen)
* insert AddCollectionEntry(mii-sp-meta-specimen-container-capacity)
* insert AddCollectionEntry(mii-sp-meta-specimen-container-specimen-quantity)
* insert AddCollectionEntry(mii-sp-meta-organization-collection-design)
* insert AddCollectionEntry(mii-sp-meta-specimen-einstellung-blutversorgung)
* insert AddCollectionEntry(mii-sp-meta-specimen-fasting-status)
* insert AddCollectionEntry(mii-sp-meta-specimen-gehoert-zu)
* insert AddCollectionEntry(mii-sp-meta-specimen-kulturprotokoll)
* insert AddCollectionEntry(mii-sp-meta-specimen-art-der-modifikation)
* insert AddCollectionEntry(mii-sp-meta-specimen-zielgen)
* insert AddCollectionEntry(mii-sp-meta-specimen-modifikationen)
* insert AddCollectionEntry(mii-sp-meta-specimen-note)
* insert AddCollectionEntry(mii-sp-meta-specimen-probenebene)
* insert AddCollectionEntry(mii-sp-meta-specimen-processing-temp)
* insert AddCollectionEntry(mii-sp-meta-organization-collection-setting)
* insert AddCollectionEntry(mii-sp-meta-organization-contact-rolle)