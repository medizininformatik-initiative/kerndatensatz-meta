...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-meta/StructureDefinition/mii-ex-meta-license-codeable | *Version*:2027.0.0-ballot.rc1 |
...
> **Veraltet — nicht mehr verwenden**Die Extension MII EX Meta License Codeable ist veraltet und SOLL NICHT mehr verwendet werden. Stattdessen SOLL die [CRMI License Extension](https://hl7.org/fhir/uv/crmi/en/StructureDefinition-crmi-license.html) verwendet werden.

Diese Extension wurde eingeführt, um maschinenverarbeitbare Lizenzinformationen über das von einer Ressource beschriebene Artefakt bereitzustellen. Sie ist eine R4-kompatible Version der FHIR for FAIR R4B IG [Licence Terms as CodeableConcept-Extension](https://hl7.org/fhir/uv/fhir-for-fair/STU1/StructureDefinition-licenceCodeable.html).
...
Simple Extension with the type CodeableConcept: This extension may be used to provide machine-processable license information about the set of data described by this resource. The extension is a R4-compatible version of the FHIR for FAIR R4B IG Licence Terms as CodeableConcept extension.
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-ex-meta-license-codeable.csv), [Excel](../StructureDefinition-mii-ex-meta-license-codeable.xlsx), [Schematron](../StructureDefinition-mii-ex-meta-license-codeable.sch) 
...
```json
{
  ...
  },
  {
    ...
    "valueMarkdown" : "Do not use this deprecated extension for new artifacts. Use the CRMI License extension (http://hl7.org/fhir/uv/crmi/StructureDefinition/crmi-license) instead."
  },
  {
