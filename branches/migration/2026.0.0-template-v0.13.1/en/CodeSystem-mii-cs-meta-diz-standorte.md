...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/core/CodeSystem/core-location-identifier | *Version*:2027.0.0-ballot.rc1 |
| Active as of 2026-05-18 | *Computable Name*:MII_CS_Meta_DIZ_Standorte |
| **Copyright/Legal**: Medizininformatik-Initiative | |

 
Medizininformatik-Initiative Standorte 

This complete, active CodeSystem identifies 52 Medical Informatics Initiative sites. Its canonical URL is intentionally retained in the MII core namespace. The generated artifact sections below provide the concept list and the JSON and XML representations.
